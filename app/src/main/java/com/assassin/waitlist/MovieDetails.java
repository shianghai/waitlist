...
import com.assassin.waitlist.interfaces.OnGetSingleMovieCallback;
...
public class MovieDetails extends AppCompatActivity {
    ...
    private void getMovie() {
        moviesRepository.getMovie(movieId, new OnGetMovieCallback(){
            @Override
            public void onSuccess(MovieInfo movie) {
    ...
    private void getGenres(final MovieInfo movie) {
        moviesRepository.getGenres(new OnGetGenresCallback() {
            @Override
            public void onSuccess(List<GenreInfo> genres) {
                if (movie.getGenres() != null) {
                    List<String> currentGenres = new ArrayList<>();
                    for (GenreInfo genre : movie.getGenres()) {
    ...
    private void getTrailers(MovieInfo movie) {
    ...
    private void getReviews(MovieInfo movie) {
